...
export default function NavbarMobile({ open, setOpen, pages, product }) {
  return (
    <>
                ...
                <Tab.Group as="div" className="mt-2">
                  <div className="border-b border-gray-200">
                    <Tab.List className="-mb-px flex space-x-8 px-4">
                      <Tab className="border-indigo-600 text-indigo-600 flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium">
                        PRODUCTOS
                      </Tab>
                    </Tab.List>
                  </div>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  {pages.map((page) => (
                    <div key={page.name} className="flow-root">
                      <Link to={`${page.id}/`}>
                        <span className="-m-2 block px-2 font-medium text-gray-900 text-base">
                          {page.name}
                        </span>
                      </Link>
                    </div>
